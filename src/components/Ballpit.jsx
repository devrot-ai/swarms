...
// Standard MeshPhysicalMaterial — clearcoat + env map gives glossy spheres
// (Custom subsurface scattering shader removed for Three.js 0.183 compat)
...
const Ballpit = ({ className = '', followCursor = true, ...props }) => {
  ...
  return <canvas className={className} style={{ width: '100%', height: '100%' }} ref={canvasRef} />;
};
